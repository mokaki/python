...
DL00 = str(DL01+'88dbDate-顧問'+time.strftime('%Y%m')+DL02)				#文件名	88dbDate-202009.txt
fp = open(DL00, "a", encoding="utf-8" )							#開/創文件
fp.writelines('88dbDate-顧問'+time.strftime('%H%M%S')+'\n')			#文件第一行
fp.close()
